...
app.layout = html.Div(children=[html.H1('Australia Wildlife Dashboard', style = {'textAlign':'center', 'color':'#503D36', 'font-size':36}),
...
#outer division starts
     html.Div([
                   # First inner divsion for  adding dropdown helper text for Selected Drive wheels
                    ...
                    html.Div([
                            html.H2('Select year', style={"align":"left"}),
